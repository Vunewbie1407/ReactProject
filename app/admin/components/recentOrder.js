                ...
                <a href="#" className="py-2 mb-0 small lh-sm border-bottom w-100 text-decoration-none text-body-secondary">
                    <strong className="d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <span className="badge bg-success-subtle text-success"><i className="far fa-money-bill-wave"></i> {total.Money}</span>
                        </div>
                    </strong>
                    Đặt bởi <i>{order.user.fullname}</i> {order.create_at}
                </a>
            </div>
            <div className="d-flex text-body-secondary pt-3">
